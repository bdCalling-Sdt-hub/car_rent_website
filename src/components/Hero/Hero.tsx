    ...
    return (
        <div className='relative'>
            ...
            <div className='absolute top-0 left-0  w-full h-full flex flex-col items-center justify-center text-white'>
                ...
                <p className='max-w-screen-md text-center font-lora'>Whether you are planning a weekend getaway, a business trip, or just need a reliable ride for the day, we offers a wide range of vehicles to suit your needs.</p>

                <div className='flex items-center cursor-pointer '>
                    <p className='bg-[#272121] mt-5 py-4 rounded-full px-8 font-lora '>Whether you are planning a weekend getaway </p>
