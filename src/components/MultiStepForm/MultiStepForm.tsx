...
import { useGetCityQuery } from "@/redux/Api/registerCarApi";
        ...
        <div className="w-full">
            ...
            <Select>
                ...
                <SelectContent className="h-full">
                    <SelectGroup>
                        {
                            getCity?.data?.destinations?.map((city :location)=> <SelectItem key={city?._id} value={city?.name}>{city?.name}</SelectItem>)
                        }
