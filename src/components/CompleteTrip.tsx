        ...
        <div>
            <div className='border-b pb-8'>
                <div className='grid grid-cols-1 md:grid-cols-12 gap-5 font-lora   '>
                    <div className='col-span-8  md:flex items-center gap-5'>
                        <Image alt='img' src={img} className='h-52 md:w-64 w-full' height={200} width={200} />
                        <div className=''>
                ...
                <div className='grid grid-co md:grid-cols-12 mt-10 gap-10 '>
            ...
            <div className='border-b pb-8 mt-5'>
                <div className='grid grid-cols-1 md:grid-cols-12 gap-5 font-lora   '>
                    <div className='col-span-8  md:flex items-center gap-5'>
                        <Image alt='img' src={img} className='h-52 md:w-64 w-full' height={200} width={200} />
                        <div className=''>
