...
const HostEarning = () => {
    return (
        <div className='font-lora '>
            <div className='md:flex  justify-between items-center gap-20 space-y-4 md:space-y-0'>
            ...
            <div className='mt-10 space-y-10'>
                ...
                <div className='grid  grid-cols-1 md:grid-cols-12 items-center gap-5 bg-[#BCBABA26] rounded-sm '>
                    ...
                    <div className='col-span-4 text-center text-[18px] md:text-[32px]  text-[#528AAE]'>
                        <p>Price :</p>
                        <p> £125.00 Pending</p>
                    </div>
                </div>
