    ...
    <div className='container mx-auto  my-5 md:my-10 md:px-0 px-2 '>
      ...
      <div className="space-y-6">
        ...
        <ul className="list-disc pl-6 space-y-2 text-gray-700">
          ...
          <li>
            <span className="font-bold">Maintain good ratings.</span> Provide a five-star experience to keep guests coming back. We track host performance and pay special attention to your ratings and reviews. If you fall below our standards, we'll provide you with a warning and an opportunity to improve.
          </li>
        </ul>
      </div>
      ...
      <div className="space-y-6">
        ...
        <ul className="list-disc pl-6 space-y-2 text-gray-700">
          <li>
            <span className="font-bold">Create an attractive listing:</span> Share vehicle details. Highlight your vehicle's unique features and let your personality shine through.
          </li>
          <li>
      ...
      <div className="space-y-6">
        ...
        <ul className="list-disc pl-6 space-y-2 text-gray-700">
          ...
          <li>
            <span className="font-bold">Stay current and avoid canceling reservations:</span> It’s an emergency. Cancellations can negatively impact your search results.
          </li>
          <li>
